        ...
        <div className="Navbar">
            <Layout>
                ...
                >
                    <Menu theme="dark" mode="inline" defaultSelectedKeys={['4']} mode="vertical">
                        ...
                        <Link to="/Cours"><SubMenu key="sub1" icon={<FolderOutlined/>} title="COURS">
                            <Menu.Item key="2" icon={<FolderOutlined/>}><Link
                                to="/Mathématique"></Link>Mathématique</Menu.Item>
                            <Menu.Item key="3" icon={<FolderOutlined/>}><Link to="/Physique"></Link>Physique</Menu.Item>
                            <Menu.Item key="4" icon={<FolderOutlined/>}><Link
                                to="/informatique"></Link>Informatique</Menu.Item>
                            ...
                            <Menu.Item key="7" icon={<FolderOutlined/>}><Link
                                to="/Biologie"></Link> Biologie</Menu.Item>
                        ...
                        <Menu.Item key="8" icon={<SettingOutlined/>}> <Link to="/Admin"></Link> Admin </Menu.Item>
                ...
                <Layout className="site-layout" className="l">
                    ...
                    <Content style={{
                        margin: '24px 16px 0', overflow: 'initial', width: "980px",
                        marginLeft: "203px"
                    }}>
            ...
            <Footer style={{textAlign: 'center'}}>ZENNOU <span style={{color: "red"}}></span> ©2021 - Tous les
                droits sont réservés</Footer>
        </div>
    );
}
